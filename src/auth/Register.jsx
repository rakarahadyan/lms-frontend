...
const RegisterPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post("http://localhost/lms-api/api/auth/register.php", form);
        ...
        <div className="min-h-screen w-screen flex items-center justify-center bg-gradient-to-b from-slate-50 to-slate-100">
            <div className="w-full max-w-md bg-white shadow-lg rounded-2xl p-8">
                <div className="text-center mb-6">
                    ...
                    <h2 className="text-3xl font-bold text-slate-700">Buat Akun Baru</h2>
                    <p className="text-slate-500">Daftar untuk mulai belajar</p>
                </div>
